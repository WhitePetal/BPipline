...
public class BSDF_LUT_KK_Inspector : MShaderGUI
{
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		if (emissionOn)
		{
			materialEditor.TexturePropertySingleLine(MakeLable("EmissionMap RGB:Color A:Mask"), FindProperty("_EmissionMap", properties), FindProperty("_EmissionStrength", properties));
		...
		materialEditor.TexturePropertySingleLine(MakeLable("高光扰动图"), shiftTex);
		materialEditor.TextureScaleOffsetProperty(shiftTex);
		materialEditor.ShaderProperty(FindProperty("_ShiftStrength"), MakeLable("高光扰动强度"));
		materialEditor.ShaderProperty(FindProperty("_Shifts_SpecularWidths"), MakeLable("Shifts_SpecularWidth"));
