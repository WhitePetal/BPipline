...
public class BRDF_LUT_Alpha_Inspector : MShaderGUI
{
	...
	protected Level level = Level.Hight;
	...
	public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
	{
		...
		if (level == Level.Hight) materialEditor.TexturePropertySingleLine(MakeLable("NormalMap"), FindProperty("_NormalTex"));
