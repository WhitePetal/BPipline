Shader "Lit/PBR/High/PBR_BSSSDF_LUT"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (a2v v)
            {
                ...
                o.pos_world.xyz = TransformObjectToWorld(v.vertex.xyz).xyz;
            ...
            FragOutput frag (v2f i)
            {
                ...
                for(int lightIndex = 0; lightIndex < _DirectionalLightCount; lightIndex++)
                {
                    ...
                    brdfCol += BSSSDF_FromLUT_DirLight(shadingParams);
                }
