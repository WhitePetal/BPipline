Shader "Lit/PBR/High/PBR_BRDF_Alpha_LUT"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            FragOutput frag (v2f i)
            {
                ...
                shadingParams.albedo = lerp(GET_PROP(_DiffuseColor).rgb * mainTex.rgb,
        ...
        Pass
        {
            ...
            FragOutput frag (v2f i)
            {
                ...
                col.rgb = lerp(col.rgb, col.rgb * GET_PROP(_BloomColor), bloom);
                FragOutput output;
                half alpha = mainTex.a * GET_PROP(_DiffuseColor).a;
                output.color = half4(col, alpha);
                output.flags = half4(bloom, 0.0, 0.0, alpha);
                // col = lerp(col * _BloomColor, col, bloom);
                return output;
            }
